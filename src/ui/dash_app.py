...
def update_weekly_report(fiscal_year, fiscal_week):
    ...
    table = dash_table.DataTable(
        ...
        style_data_conditional=(
            ...
            # Bars are 50% width - thinner, more subtle
            ...
            [
                {
                    ...
                    'background': f'linear-gradient(90deg, white 0%, white 50%, #00B050 50%, #00B050 {50 + (i+2.5)/100*25}%, white {50 + (i+2.5)/100*25}%)',
                    'color': '#000000',
                    'fontWeight': 'bold'
                }
            ...
            [
                {
                    ...
                    'background': f'linear-gradient(90deg, white 0%, white {50 - (i+2.5)/100*25}%, #FF0000 {50 - (i+2.5)/100*25}%, #FF0000 50%, white 50%)',
                    'color': '#000000',
                    'fontWeight': 'bold'
                }
                for i in range(0, 100, 5)
