...
def update_weekly_report(fiscal_year, fiscal_week):
    ...
    table = dash_table.DataTable(
        ...
        style_data_conditional=(
            ...
            # Thin bars - max 15% width from center for subtle appearance
            ...
            [
                {
                    ...
                    'background': f'linear-gradient(90deg, white 0%, white 50%, #00B050 50%, #00B050 {50 + min(15, (i+2.5)*0.15)}%, white {50 + min(15, (i+2.5)*0.15)}%)',
                    'color': '#000000',
                    'fontWeight': 'bold'
                }
            ...
            [
                {
                    ...
                    'background': f'linear-gradient(90deg, white 0%, white {50 - min(15, (i+2.5)*0.15)}%, #FF0000 {50 - min(15, (i+2.5)*0.15)}%, #FF0000 50%, white 50%)',
                    'color': '#000000',
                    'fontWeight': 'bold'
                }
                for i in range(0, 100, 5)
