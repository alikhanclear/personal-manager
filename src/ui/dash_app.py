            ...
            [
                {
                    ...
                    'background': f'linear-gradient(90deg, white 0%, white 50%, #00B050 50%, #00B050 {50 + (i+2.5)/100*30}%, white {50 + (i+2.5)/100*30}%)',
                    'color': '#006400',
                    'fontWeight': 'bold'
                }
            ...
            [
                {
                    ...
                    'background': f'linear-gradient(90deg, white 0%, white {50 - (i+2.5)/100*30}%, #FF0000 {50 - (i+2.5)/100*30}%, #FF0000 50%, white 50%)',
                    'color': '#8B0000',
                    'fontWeight': 'bold'
                }
                for i in range(0, 100, 5)
